...
SECRET_KEY = 'of7=sbgleba3(#_)!iw_v0kir1ld^$i!+)#wkr!0kq%w72ur_#'
...
EMAIL_HOST_PASSWORD = 'YOURPASSWORD' # create app password here
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "static_in_pro", "our_static"), # actual path in this project
    # os.path.join(BASE_DIR, "static_in_env"),
    # '/var/www/static/', # not relevant for us here
)
